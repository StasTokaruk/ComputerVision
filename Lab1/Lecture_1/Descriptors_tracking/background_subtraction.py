...
Відстеження об'єктів шляхом позбавлення від фону
...
def get_frame(cap, scaling_factor):
    '''
    функція захоплення кадру у відеопотоці для порівняння
    '''
...
if __name__=='__main__':
    ...
    while True:
        ...
        '''
         Аналіз кольорового простору через створення образу, шляхом навчання за кадрами
